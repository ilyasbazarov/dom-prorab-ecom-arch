...
**Версия:** v0.6 · **updated:** 2026-07-26 · Architect (сессия arch_p19_checkdigit_perimeter)
...
- [Business] BQ-07 — какой номер показывать клиенту в возвратах/рекламациях (P-31: #10/#13 показывают внутренний ID смарт-процесса). Три варианта с ценой — l2-registers/open_questions.md; рекомендация Architect — составной номер. В повестку той же Business-сессии, что BQ-01…BQ-06.
