...
**Версия:** v1.42 · **updated:** 2026-08-12 · session `arch_f4_17_brief`, блок 9 (Architect режим A, Claude Code, Opus): СОБРАН ПУСК Reviewer-сессии `F4-13` — `reference/2026-08-12_f4_13_launch.md`, копируется целиком, слотов нет. Счёт хвоста пересчитан и исправлен: записей в статусе `proposed` ТРИДЦАТЬ ТРИ, а не двадцать, как значилось строкой 6 — 31 заголовочной формы плюс `ADR-070` и `ADR-071` списочной; ARCH 31, PROCESS 2. Роли отдан главный класс риска: часть записей писалась до решений, которые их обогнали, и апрув ратифицировал бы неверный текст при запрете править тело (ADR-016) — два случая предъявлены адресами. Раньше: разбор очереди на параллелимость; тема правила выхода STATE закрыта; `F4-17` сужена до восьми шагов и ждёт воронки; гейта OQ-08 нет, `CQ-36`…`CQ-44` в SENT. Подробности — §Подробности для модели.
...
ней прогон `F4-17`. Параллельно сессией — `F4-13`, пуск собран и копируется целиком.
