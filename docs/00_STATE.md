...
| CC-пилот (ADR-027…029) | SCAFFOLD применён этим коммитом; пилотный бриф — F5-01 (Owner); гейт запуска: самотест хука на машине Owner «провалено 0» |
