...
**Версия:** v1.38 · **updated:** 2026-08-12 · session `arch_f4_17_brief`, блок 5 (Architect режимы A и B, Claude Code, Opus): РЕШЕНИЕ OWNER ПО РАЗВИЛКЕ Р-3, ВАРИАНТ В (ADR-137, `proposed` по К-40 как запись класса PROCESS). У КАЖДОГО раздела STATE появилось правило выхода и машинный лимит, а не только у стенд-апа: шапка 2500 байт целиком, §Подробности — индекс на 150 строк, §Открытые вопросы — указатели на 15 строк. Файл 267 788 → 21 517 байт, потери 0: 66 абзацев и осиротевшая строка шапки на 22 360 байт перенесены в `docs/00_STATE_ARCHIVE.md` дословно, 73 наблюдения без владельца — в новый `docs/10_SCARS.md` номерами `Ш-01`…`Ш-73`, три учётных пункта снял реестр. К-19 переиздана, самотест 94 против 88. Раньше в блоке 3: `F4-17` сужена до восьми шагов, гейт — воронка, остаток в `F4-24`; гейта OQ-08 на задаче нет, `CQ-36`…`CQ-44` в SENT. Подробности — §Подробности для модели.
...
**Прошлый шаг.** `arch_f4_17_brief`: `F4-17` сужена до восьми шагов (ADR-136), а сам STATE ужат
с 268 до 21 КБ правилом выхода для каждого раздела (ADR-137), без потери содержания.
...
**Идёт своей дорожкой.** Строка 6 (`F4-13`) — фоном. Строка 3 (`M1-12`, скрипт сверки пакета)
остаётся PENDING. Строка 13 параллельной быть перестала — она гейт прогона.
