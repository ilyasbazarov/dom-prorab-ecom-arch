...
docs/00_STATE.md            — стенд-ап, индекс сессий, статус фаз, указатели, блокеры (LIVING; лимит каждого раздела машинный, ADR-137)
docs/10_SCARS.md            — шрамы метода Ш-NN: наблюдения без владельца и признака закрытия (LIVING)
